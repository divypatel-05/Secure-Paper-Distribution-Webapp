...
const Invigilator = ({ name, email, phone }) => {
    return (
        <div className="mx-auto bg-white rounded-lg shadow-md overflow-hidden border border-gray-300 mb-4">
            <div className="px-6 py-4">
                <h2 className="text-xl font-bold mb-2 text-gray-800">Invigilator Name: {name}</h2>
